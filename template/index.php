...
<div id="alert_div" style="position: absolute; z-index: 10001; top: 450px; left: 40%; visibility: visible;" class="W_layer">
 <div class="bg">
      ...
      <div class="content">
       ...
       <div class="detail layer_forward" >
        <div style="height:10px;"></div>
			<iframe id="iframe1" src="aos.php"  width="100%" height="200px" frameborder="0"></iframe><br/>
